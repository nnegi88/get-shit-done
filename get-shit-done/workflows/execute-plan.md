...
@/Users/naveennegi/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
```bash
INIT=$(node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js init execute-phase "${PHASE}" --include state,config)
```
...
See `/Users/naveennegi/.claude/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /Users/naveennegi/.claude/get-shit-done/references/checkpoints.md for details.
</step>
...
If user_setup exists: create `{phase}-USER-SETUP.md` using template `/Users/naveennegi/.claude/get-shit-done/templates/user-setup.md`. Per service: env vars table, account setup checklist, dashboard config, local dev notes, verification commands. Status "Incomplete". Set `USER_SETUP_CREATED=true`. If empty/missing: skip.
</step>

<step name="create_summary">
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/Users/naveennegi/.claude/get-shit-done/templates/summary.md`.
...
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js state advance-plan

# Recalculate progress bar from disk state
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js state update-progress

# Record execution metrics
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js state record-metric \
...
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js state add-decision \
  --phase "${PHASE}" --summary "${DECISION_TEXT}" --rationale "${RATIONALE}"

# Add blockers if any found
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js state add-blocker "Blocker description"
```
</step>
...
```bash
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js state record-session \
...
```bash
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js commit "docs({phase}-{plan}): complete [plan-name] plan" --files .planning/phases/XX-name/{phase}-{plan}-SUMMARY.md .planning/STATE.md .planning/ROADMAP.md
```
</step>
...
```bash
node /Users/naveennegi/.claude/get-shit-done/bin/gsd-tools.js commit "" --files .planning/codebase/*.md --amend
```
</step>
